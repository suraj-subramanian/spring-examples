package com.smita.spring_emp.controller;
...
import com.smita.spring_emp.service.IEmployeeService;
/** @author Smita **/
...
public class EmployeeController {
	...
	//http://localhost:8082/api/employees/empList
	@GetMapping(value="",produces="application/json")
	public List<Employee> getAll() throws EmployeeException{
			return employeeService.getEmployeeList();
	}
	
	//http://localhost:8082/api/employees/getEmp/1
	@GetMapping("/{employeeId}")
    public ResponseEntity<Employee> 
	getEmployeeById(@PathVariable(value = "employeeId") Long employeeId) throws EmployeeException{
		System.out.println("EmployeeController -> find : "+employeeId);
		Employee employee =employeeService.getEmployeeById(employeeId);
		return ResponseEntity.ok().body(employee);
	}
	//http://localhost:8082/api/employees/addEmp
	@PostMapping("/save")
    ...
    public HttpStatus updateEmployee(@PathVariable(value = "employeeId") 
    Long employeeId,
    ...
    public Map<String, Boolean> deleteEmployee(@PathVariable(
    		value = "employeeId") 
    Long employeeId) throws EmployeeException{
		 Employee employee = employeeService.getEmployeeById(employeeId);
