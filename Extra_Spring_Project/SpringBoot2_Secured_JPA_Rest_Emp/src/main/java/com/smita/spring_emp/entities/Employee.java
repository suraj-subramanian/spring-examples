package com.smita.spring_emp.entities;
...
@Table(name="emp_ng_rest") // tell JPA that this class object need to be mapped with this table
public class Employee {
	@Id //Primary key
	//@GeneratedValue(strategy=GenerationType.TABLE)
	@SequenceGenerator(name="EMP_GEN" ,
	sequenceName="emp_ng_rest_seq",allocationSize=1)
